...
#### 6.If only specific groups needs to executed, then follow the below steps and then run using maven command or testNG.xml file
...
<img width="559" height="1659" alt="image" src="https://github.com/user-attachments/assets/e281316f-68cd-4773-aa74-e1bd3a679fde" />
...
-  [Click here and download Extent HTML Report generated by me after executing the Suite] [(https://github.com/Geetha-1985/My-project-reports)](https://github.com/Geetha-1985/My-project-reports/blob/main/ExtentReport.html)
